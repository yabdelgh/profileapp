...
public class AppApplication {
    ...
    private void createProjectState(){
            ...
            itemSuccess.setLabel("Validated");
    ...
    private static void addPermission(List<ModelPermission> modelPermissions) {
        ...
        modelPermissions.add(new ModelPermission("Profile"));
        modelPermissions.add(new ModelPermission("Student"));
        modelPermissions.add(new ModelPermission("Login"));
